public class Battle {
    public void fight(FantasyCharacter hero, FantasyCharacter monster, GameWorld.FightCallback fightCallback) {
    ...
    private Boolean makeHit(FantasyCharacter defender, FantasyCharacter attacker, GameWorld.FightCallback fightCallback) {
